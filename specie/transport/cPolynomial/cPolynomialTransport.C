...
#include "cPolynomialTransport.H"
#include "IOstreams.H"

// * * * * * * * * * * * * * * * * Constructors  * * * * * * * * * * * * * * //

template<class Thermo, int PolySize>
Foam::cPolynomialTransport<Thermo, PolySize>::cPolynomialTransport
(
...
template<class Thermo, int PolySize>
void Foam::cPolynomialTransport<Thermo, PolySize>::write(Ostream& os) const
{
...
(
    Ostream& os,
    const cPolynomialTransport<Thermo, PolySize>& pt
)
{
    pt.write(os);
    return os;
